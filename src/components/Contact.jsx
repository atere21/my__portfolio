...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#0a132f] flex jusify-center items-center p-4'  >
     <form method='post' action='https://getform.io/f/7db35b52-2504-4784-b131-ed5673e83177' className='flex flex-col max-w-[400px] pb-5 shadow-lg shadow-[#040c16] group container rounded-md jusify-center my-6  mx-auto contactForm' >
      <div className='pb-2'>
