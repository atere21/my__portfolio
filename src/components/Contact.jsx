...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-full bg-[#0a132f] flex justify-center items-center mt-0 md:pt-[22rem] mb-8  '>
   <form
        method='post'
      ...
      >
        ...
        <textarea className='bg-[#ccd6f6] h-64 p-2 rounded-md my-2 mx-4 ' placeholder='Message' name='message' cols='30' rows='10'></textarea>
